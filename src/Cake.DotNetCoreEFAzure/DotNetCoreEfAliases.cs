...
namespace Cake.DotNetCoreEfAzure
{
    [CakeAliasCategory("DotNetCoreEfAzure")]
    public static class DotNetCoreEfAzureAliases
    {
        /// <summary>
        ...
        [CakeNamespaceImport("Cake.DotNetCoreEfAzure.Database")]
        ...
        [CakeNamespaceImport("Cake.DotNetCoreEfAzure.Migration")]
